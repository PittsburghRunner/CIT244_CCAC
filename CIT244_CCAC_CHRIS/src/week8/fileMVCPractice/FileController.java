...
public class FileController {
    ...
    public List<Student> retrieveStudents(String filename){
        List<Student> contents = model.getStudentsFromFile(filename);
        System.out.println("Retrieving file contents : " + contents);
        return contents;
