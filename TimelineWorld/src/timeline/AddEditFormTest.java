 ...
 * @author ceckles
 */
public class AddEditFormTest extends javax.swing.JPanel {
    Component component;
    HashMap<String, Object> map = new HashMap<>();
    ArrayList<Prompt> prompts = FieldHelpers.retrieveClassFieldsForPrompting(component.getClass());

    /**
     * Creates new form AddEditForm
     */
    public AddEditFormTest() {
        component = new Component();
        map = new HashMap();
        initComponents();
    }
    public AddEditFormTest(Component selectedComponent) {
    ...
    private void initComponents() {
        ...
        for(Prompt p : prompts){
           p.getTextField().setText((String)map.getOrDefault(p.getField().getName(), ""));
        }
        ...
        addEditPanelLayout.setHorizontalGroup(
            ...
            .addGroup(addEditPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(addEditPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).generateHorizontalFieldGroups())
                    )
                .addContainerGap());
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        try {
            ...
            Logger.getLogger(AddEditFormTest.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private Group generateHorizontalFieldGroups(GroupLayout layout){
        return
        .addGroup(addEditPanelLayout.createSequentialGroup()
